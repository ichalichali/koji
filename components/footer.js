    ...
    <div>
      <footer aria-label="Site Footer" class="bg-white">
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div class="lg:flex lg:items-start lg:gap-2">
              ...
              <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form class="w-full">
                  ...
                  <div class="p-2 border border-gray-100 focus-within:ring sm:flex sm:items-center sm:gap-4">
                    ...
                    <button class="w-full px-6 py-3 mt-1 text-sm font-bold tracking-wide text-white uppercase transition-none bg-teal-500 hover:bg-teal-600 sm:mt-0 sm:w-auto sm:flex-shrink-0">
                      Sign Up
                    </button>
                  </div>
                </form>
